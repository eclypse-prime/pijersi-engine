...
SRC=src/alphabeta.cpp src/board.cpp src/hash.cpp src/logic.cpp src/lookup.cpp src/nn.cpp src/rng.cpp src/utils.cpp
OBJ=src/alphabeta.o src/board.o src/hash.o src/logic.o src/lookup.o src/nn.o src/rng.o src/utils.o
