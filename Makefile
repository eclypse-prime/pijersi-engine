INCLUDE=-Iinclude
HEADERS=include/alphabeta.hpp include/board.hpp include/hash.hpp include/logic.hpp include/nn.hpp include/piece.hpp include/rng.hpp
FLAGS=-Wall -flto -O3 -fopenmp
SRC=src/alphabeta.cpp src/board.cpp src/hash.cpp src/logic.cpp src/rng.cpp
OBJ=src/alphabeta.o src/board.o src/hash.o src/logic.o src/rng.o
