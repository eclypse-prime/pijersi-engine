...
namespace PijersiEngine
{
    ...
    public:
        ...
        uint32_t searchDepth(int recursionDepth, bool random, size_t side, uint32_t prinvipalVariation = NULL_MOVE, uint64_t searchTimeMilliseconds = UINT64_MAX, bool iterative = true);
        uint32_t playDepth(int recursionDepth, bool random, size_t side, uint32_t prinvipalVariation = NULL_MOVE, uint64_t searchTimeMilliseconds = UINT64_MAX, bool iterative = true);

        // Time limited search
        
        uint32_t searchTime(bool random, size_t side, uint64_t searchTimeMilliseconds = UINT64_MAX);
        uint32_t playTime(bool random, size_t side, uint64_t searchTimeMilliseconds = UINT64_MAX);
