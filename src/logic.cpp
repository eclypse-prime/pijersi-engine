...
#pragma omp parallel for schedule(dynamic)
    ...
    void move(uint64_t indexStart, uint64_t indexEnd, uint8_t cells[45])
    {
    ...
    void stack(uint64_t indexStart, uint64_t indexEnd, uint8_t cells[45])
    {
        uint8_t movingPiece = cells[indexStart];
        uint8_t endPiece = cells[indexEnd];
    ...
    void unstack(uint64_t indexStart, uint64_t indexEnd, uint8_t cells[45])
    {
        uint8_t movingPiece = cells[indexStart];
